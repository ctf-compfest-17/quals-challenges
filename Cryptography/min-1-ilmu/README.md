...
```
COMPFEST17{wow_you_must_be_a_genius_to_be_able_to_3_color_that_graph}
```

## Description
wait, a rainbow can be made from 3 colors?

Note: There are 2 intended vulnerability, if you want to have a challenge, try to exploit both of them.
