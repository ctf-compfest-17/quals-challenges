...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p5 = RealNumber('0.5'); _sage_const_7 = Integer(7); _sage_const_2 = Integer(2); _sage_const_1000 = Integer(1000); _sage_const_3 = Integer(3); _sage_const_9 = Integer(9); _sage_const_4 = Integer(4)#from pwn import *
...
if __name__ == "__main__":
    #proc = remote("ctf.compfest.id", 6192)
    #proc = process(["python3", "../src/src.py"])

    with open("../public/output.txt") as f:
        text = f.read()
        N = int(re.search(r"N:\s*([0-9]+)", text).group(_sage_const_1 ))
        e = int(re.search(r"e:\s*([0-9]+)", text).group(_sage_const_1 ))
        ct = int(re.search(r"ct:\s*([0-9]+)", text).group(_sage_const_1 ))
